...
class BookCreationForm(FlaskForm):
    book_title = StringField("Book Title",validators=[InputRequired('Book Title is required!')])
    isbn = StringField("ISBN",validators=[InputRequired("ISBN is required!")])
    author = StringField("Author",validators=[InputRequired("Author name is required!")])
    ...
    book_condition = SelectField(u'Book Condition', choices=[
                                ...
                                , ('VERY_GOOD', 'Very good')
                                , ('GOOD', 'Good - used')
                                , ('WEAR_AND_TEAR', 'Some wear and tear')
                                , ('WORN', 'Worn')],
    ...
    autograph_status = SelectField(u'Autograph Status', 
                            choices=[('XX','Specify if the book is autographed'),
                                     ('TRUE', 'True'),
                                     ('FALSE', 'False')],
                            validators=[InputRequired("A autograph status should be selected")],
                            default="XX")
    ...
    listing_title = StringField("Listing Title",validators=[InputRequired("A listing title is required!")])
    description = TextAreaField("Description",validators=[InputRequired("A description is required!")])
    starting_bid = FloatField("Starting Bid",validators=[InputRequired("A starting bid is required!")])
